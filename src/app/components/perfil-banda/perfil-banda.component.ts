...
export class PerfilBandaComponent implements OnInit {
  ...
  ngOnInit() {
    //Coge el id pasado en la ruta para traer los datos de la BBDD
    ...
    // Trae las actuaciones de la banda segun el id
  ...
  onDateSelected(event: MatDatepickerInputEvent<Date, unknown>) {
   ...
   /*========================================================================================================================== 
    ==========================================================================================================================
                          ...
                          Funcion que inserta actuaciones a partir del id_banda, fecha seleccionada y del login_id
  ...
  reservarFecha() {
   ...
   /*========================================================================================================================== 
    ==========================================================================================================================
                  ...
                  Función que elimina una actuacion si eres admin o eres el usuario al que esta asociada la banda
  ...
  eliminarFecha() {
   ...
   /*========================================================================================================================== 
    ==========================================================================================================================
                                   ...
                                   funciones activadoras del menu si eres admin o usuario de la banda
  ...
  cerrarContactoBanda(){
   ...
   /*========================================================================================================================== 
    ==========================================================================================================================
                              ...
                              Función que muestra un mensaje tipo toast
